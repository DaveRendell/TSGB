...
export default class TetrisConnection extends OnlineConnection<TetrisMessage, TetrisState> {
  constructor(serialRegisters: SerialRegisters) {
    super(serialRegisters, (self) => new NegotiationState(self), parseMessage)
  }
}
...
//   setClockMs(timeoutMs: number) {
//     this.clockTimer = timeoutMs * CLOCKS_1_MS
//   }

//   setGameState(newState: TetrisState): void {
